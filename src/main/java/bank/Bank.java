...
public interface Bank {
     ...
     * @throws TransactionAttributeException    if the validation check for certain attributes fail - getter, setter, usw.
     */
    ...
    void removeTransaction(String account, Transaction transaction)
            throws AccountDoesNotExistException, TransactionDoesNotExistException, TransactionAttributeException, IOException;

    /**
     * Deletes an account from a Private Bank Object. If the given account does not exist, an exception is thrown.
    ...
    /**
     * Returns a List of all accounts in a bank
     * @return a List of String with all relevant account infos
     */
